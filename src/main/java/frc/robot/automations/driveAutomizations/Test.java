...
public class Test extends PIDCommand {
  /** Creates a new Test. */
  public Test(Swerve m_swerve, DoubleSupplier translationX, DoubleSupplier translationY, DoubleSupplier rotationSup) {
    super(
        // The controller that the command will use
        new PIDController(0.007, 0, 0.001),
